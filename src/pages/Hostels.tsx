...
import { Building2, Plus, Trash2, Edit, Layers, DoorOpen, Users } from 'lucide-react';
...
const Hostels = () => {
  ...
  const handleAdd = async () => {
    ...
    try {
      await addHostel({
        ...
        totalCapacity: 0 // Will be calculated from rooms
      });
  ...
  const handleDelete = async (id: string, name: string) => {
    if (confirm(`Are you sure you want to delete ${name}? This will delete all floors, rooms, and students in this hostel.`)) {
      try {
